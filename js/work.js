document.addEventListener("DOMContentLoaded", function () { 
            ...
            const translations = {
                en: {
                    ...
                    AntonioMaretti_UncensoredCherry: "Antonio Maretti Uncensored Cherry is a sweet cherry fragrance made for the winter holidays. It is designed to feel like the perfect Christmas gift, bringing a warm and festive mood to the season. <br><br> In this project, I experimented with a Christmas atmosphere and a unique simulation for the gift boxes. My goal was to show how the perfume fits naturally into a beautiful holiday setting.",
                    DrunkElephant_VirginMarula: "Drunk Elephant Virgin Marula is a project integrating the brand’s iconic facial oil into an urban environment. The concept conveys a vibrant, minimalist aesthetic through large-scale visual forms seamlessly embedded into a real-world landscape.<br><br>I focused on VFX techniques and the integration of 3D objects into live-action footage. The goal was to explore scale and lighting, transforming a product into a striking architectural element while maintaining its signature identity.",
                    Rhobe_SoftMauve: "Rhode Peptide Lip Tint: «Eyes Don't Lie» is a visual exploration inspired by the moody, atmospheric vibes of Isabel LaRosa’s music. The concept blends the brand’s signature minimalist sophistication with a dark romantic aesthetic, creating a glossy editorial flow that perfectly resonates with the track's rhythmic energy. <br> <br> The project utilizes a hybrid 2D/3D workflow, featuring meticulously crafted 3D product models in Blender integrated with authentic live-action footage from the brand’s archives to maintain a realistic feel. By layering kinetic typography with high-fidelity liquid textures, the goal was to explore the synchronization between visual motion and sound, resulting in a cohesive and high-contrast rhythmic experience.",
                    Credits2023: "Credits | 2023",
                    Credits2024: "Credits | 2024",
                    Credits2025: "Credits | 2025",
                    Credits2026: "Credits | 2026",
                    Client: "Client:",
                ...
                ru: {
                    ...
                    AntonioMaretti_UncensoredCherry: "Antonio Maretti Uncensored Cherry — это сладкий аромат вишни, созданный специально для зимних праздников. Он призван стать идеальным рождественским подарком, наполняя сезон теплым и праздничным настроением. <br><br> В этом проекте я экспериментировала с рождественской атмосферой и уникальной симуляцией подарочных коробок. Моя цель состояла в том, чтобы показать, как парфюм естественно вписывается в красивую праздничную обстановку.",
                    DrunkElephant_VirginMarula: "Drunk Elephant Virgin Marula — проект по интеграции культового масла для лица в городскую среду. Идея заключалась в передаче минималистичной эстетики бренда через масштабные визуальные формы, органично вписанные в реальный пейзаж.<br><br>В этой работе я сфокусировалась на VFX-технологиях и бесшовном совмещении 3D-объектов с видеорядом. Целью было показать, как продукт может стать эффектным арт-объектом благодаря экспериментам с масштабом и освещением.",
                    Rhobe_SoftMauve: "Rhode Peptide Lip Tint: «Eyes Don't Lie» — это визуальное исследование, вдохновленное томной и меланхоличной атмосферой музыки Изабель Ларозы. Концепция объединяет фирменную минималистичную эстетику бренда с элементами «темной романтики», создавая глянцевый журнальный стиль, который вторит ритмичной энергии трека. <br> <br> В проекте используется гибридный пайплайн 2D/3D, включающий детальные 3D-модели продуктов в Blender и аутентичную видеосъемку из архивов бренда для сохранения реалистичности. Сочетая кинетическую типографику с живыми текстурами, я стремилась достичь идеальной синхронизации движения и звука, превращая рекламный концепт в цельный и контрастный аудиовизуальный опыт.",
                    Credits2023: "Информация | 2023",
                    Credits2024: "Информация | 2024",
                    Credits2025: "Информация | 2025",
                    Credits2026: "Информация | 2026",
                    Client: "Клиент:",
                    Noncomercial: "Некомерческий проект",
                    MotionDesigner1: "Моушн Дизайнер:",
                    Designer1: "3D Дизайнер:",
                    ArtDirector2: "Моушн Дизайнер:",
                    ArtDirector3: "Моушн Дизайнер, Саунд Дизайнер:",
                    Prompter: "ИИ Промтер:",
                    Composer: "Композитор:",
                    Tools: "Инструменты:",
