document.addEventListener("DOMContentLoaded", function () { 
            ...
            const translations = {
                en: {
                    ...
                    DrunkElephant_VirginMarula: "Drunk Elephant Virgin Marula is a project focused on integrating the brand’s iconic facial oil into an urban environment. The main concept was to convey the brand's vibrant and minimalist aesthetic through large-scale visual forms, seamlessly embedded into a real-world landscape.<br><br> In this project, I experimented with VFX techniques and the seamless integration of 3D objects into live-action footage. My goal was to explore the interaction between scale and lighting, demonstrating how a product can be transformed into a striking architectural element while maintaining its signature brand identity.",
                ...
                ru: {
                    ...
                    DrunkElephant_VirginMarula: "Drunk Elephant Virgin Marula — это проект, посвященный интеграции культового масла для лица в городскую среду. Основная идея заключалась в том, чтобы передать яркую и минималистичную эстетику бренда через масштабные визуальные формы, органично вписанные в реальный пейзаж.<br><br> В этой работе я сосредоточилась на VFX-технологиях и бесшовном совмещении 3D-объектов с видеорядом. Моей целью было поэкспериментировать с масштабом и освещением, чтобы показать, как продукт может стать эффектным арт-объектом, сохраняя свою узнаваемую визуальную идентичность.",
